...
headersfile = open('./headers.txt')
headers = headersfile.read().split()

DataFrame = pd.read_csv('./queries.txt', names=headers, na_values=['?'])

CatFeatures = ['id','job','marital','education','default','housing','contact','month','poutcome']
